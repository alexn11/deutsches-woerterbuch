...
def save_translation_htmls(context_data: list[dict],
                           ...
                           style_file_path: str = 'css/dict.css',
                           do_sort: bool=False):
    translation_entries = []
...
def run_full_extraction(source_lang: str, target_lang: str,
                        ...
                        end_chunk_i: int = -1):
    tag = f'{language_names_to_tag(source_lang, target_lang)}-{chunk_size}'
...
if(__name__ == '__main__'):
    ...
    if(chunk_size == 0): # do the extract in one block
        run_full_extraction(source_lang, target_lang,
